#!/bin/bash
#SBATCH --job-name=aug_spec_sweep
...
#SBATCH -o /work/morrisliu07/job_log/aug_spec_sweep_%j.log
#SBATCH -e /work/morrisliu07/job_err/aug_spec_sweep_%j.err
...
# ════════════════════════════════════════════════════════════════════════
CONFIGS=(
    # configs/mixtral_topm_count.yaml
    # configs/mixtral_prefill_count.yaml
    configs/mixtral_prefill_topm_count.yaml
    configs/gptoss_topm_count.yaml
    configs/gptoss_prefill_count.yaml
    configs/gptoss_prefill_topm_count.yaml
    configs/qwen3_topm_count.yaml
    configs/qwen3_prefill_count.yaml
    configs/qwen3_prefill_topm_count.yaml
)
# ════════════════════════════════════════════════════════════════════════
